...
cover_path = "noise.wav"
# stego_path = "stego_audio_LSB.wav"
stego_path = "stego_audio_LSB.wav"
msg_path = "short.txt"
continuous_duration = 0.2

# def mask_msg_size(msg):
# 	sizeMask = 8
# 	sizeMask = sizeMask - len(str(len(msg)))
# 	mask=""
# 	for _ in range(sizeMask):
# 		mask+="0"
# 	return mask+str(len(msg))

# Converts each character in secret message into its binary representation.
...
def audio_stego(cover, msg, nlsb):
...
# 	# print(math.ceil(len(msg)/8))
# 	# print(sizeMask)
# 	# mask=mask_msg_size(msg)
